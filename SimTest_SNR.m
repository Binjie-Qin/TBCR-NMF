...
%         dirname = ['O:\开题报告和学位论文\论文数据\NCut初始化\信噪比的影响\orig555_' num2str(snr) 'db'];
...
%     temp = imfilter(temp, fspecial('gaussian',[3 3], 0.5));
    temp = imfilter(temp, fspecial('average',3));
...
% dirname = ['O:\开题报告和学位论文\论文数据\NCut初始化\信噪比的影响\' num2str(snr) 'db'];
% saveas(h,dirname,'png');
axis image;axis off;
% figure,imshow(mask);
...
% dirname = ['O:\开题报告和学位论文\论文数据\NCut初始化\信噪比的影响\s' num2str(snr) 'db'];
% saveas(h,dirname,'png');
...
% 
% save(['O:\开题报告和学位论文\论文数据\NCut初始化\信噪比的影响\' num2str(snr) '.mat']);
end 
